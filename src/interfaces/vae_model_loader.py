...
class LH26LoadVAEModel(io.ComfyNode):
    """
    ...
    Returns:
        LH26_VAE configuration dictionary for main upscaler node
    """
    ...
    def execute(cls, model: str, device: str, offload_device: str = "none",
        ...
        """
        Create VAE model configuration for LH2.6 main node
