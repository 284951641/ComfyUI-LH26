"""
LH2.6 Torch Compile Settings Node
...
class LH26TorchCompileSettings(io.ComfyNode):
    """Configure torch.compile optimization for DiT and VAE models"""
    
    @classmethod
    def define_schema(cls) -> io.Schema:
        return io.Schema(
            node_id="LH26TorchCompileSettings",
            display_name="LH2.6 Torch Compile Settings",
            category="LH2.6",
            description=(
                "Configure LH2.6 torch.compile optimization for 20-40% DiT speedup and 15-25% VAE speedup. "
