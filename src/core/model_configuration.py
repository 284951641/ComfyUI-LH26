"""
Model Configuration and Setup for LH2.6
...
def _acquire_runner(
    ...
    Args:
        ...
        dit_model: DiT model filename for validation (e.g., "lh26_ema_3b_fp16.safetensors")
...
def _create_new_runner(
    ...
    Loads the fixed LH2.6 3B configuration, creates
    ...
    Args:
        dit_model: LH2.6 DiT model filename
...
def configure_runner(
    ...
    Args:
        dit_model: DiT model filename (e.g., "lh26_ema_3b_fp16.safetensors")
